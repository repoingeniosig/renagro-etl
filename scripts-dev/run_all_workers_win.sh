    ...
    while [ $# -gt 0 ]; do
        case "$1" in
            ...
            *)
                ...
                echo "  ./run_all_workers.sh envio adicional capacitacion    - Solo adicional capacitación"
                echo "  ./run_all_workers.sh envio adicional comunicacion    - Solo adicional comunicación"
                echo "  ./run_all_workers.sh envio adicional produccion      - Solo adicional producción"
...
if [ "$START_ENVIO_ADDT_CAPACITACION" = true ] || [ "$START_ENVIO_ADDT_COMUNICACION" = true ] || [ "$START_ENVIO_ADDT_PRODUCCION" = true ] || [ "$START_ENVIO_ADDT_SENDER" = true ]; then
    ...
    if [ "$START_ENVIO_ADDT_CAPACITACION" = true ]; then
        ...
        ENVIO_MAG_LOGGER_NAME=worker_envio_mag_adicional python -m src.workers envio_mag_adicional_capacitacion >> logs/worker_envio_mag_adicional.log 2>&1 &
        PIDS+=($!)
    ...
    if [ "$START_ENVIO_ADDT_COMUNICACION" = true ]; then
        ...
        ENVIO_MAG_LOGGER_NAME=worker_envio_mag_adicional python -m src.workers envio_mag_adicional_comunicacion >> logs/worker_envio_mag_adicional.log 2>&1 &
        PIDS+=($!)
    ...
    if [ "$START_ENVIO_ADDT_PRODUCCION" = true ]; then
        ...
        ENVIO_MAG_LOGGER_NAME=worker_envio_mag_adicional python -m src.workers envio_mag_adicional_produccion >> logs/worker_envio_mag_adicional.log 2>&1 &
        PIDS+=($!)
    ...
    if [ "$START_ENVIO_ADDT_SENDER" = true ] || [ "$START_ENVIO_ADDT_CAPACITACION" = true ] || [ "$START_ENVIO_ADDT_COMUNICACION" = true ] || [ "$START_ENVIO_ADDT_PRODUCCION" = true ]; then
        ...
        ENVIO_MAG_LOGGER_NAME=worker_envio_mag_adicional python -m src.workers envio_mag_adicional_sender > logs/worker_envio_mag_adicional_sender.log 2>&1 &
        PIDS+=($!)
