...
ADD COLUMN "neo_observacion_no_informante_v1" TEXT,
...
ADD COLUMN "neo_observacion_no_informante_v2" TEXT,
...
CREATE SEQUENCE "sc_renagro_mag"."seq_adj_id"
INCREMENT 1
MINVALUE 1
...
CREATE TABLE "sc_renagro_mag"."adjuntos" (
    "adj_id" INTEGER NOT NULL DEFAULT nextval('"sc_renagro_mag"."seq_adj_id"'::regclass) PRIMARY KEY,
    "bol_id" INTEGER,
    ...
    CONSTRAINT "fk_adjunto_boleta"
        FOREIGN KEY ("bol_id")
        REFERENCES "sc_renagro_mag"."boletas" ("bol_id")
        ON DELETE CASCADE
);

CREATE SEQUENCE "sc_renagro_mag"."seq_pobo_id"
INCREMENT 1
MINVALUE 1
MAXVALUE 9223372036854775807
START 1
...
CREATE TABLE "sc_renagro_mag"."poligonos_boleta" (
    "pobo_id" INTEGER NOT NULL DEFAULT nextval('"sc_renagro_mag"."seq_pobo_id"'::regclass) PRIMARY KEY,
